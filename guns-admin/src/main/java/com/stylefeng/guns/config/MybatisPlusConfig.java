...
import com.stylefeng.guns.core.mutidatasource.config.ThreeDataSourceProperties;
...
public class MybatisPlusConfig {
    ...
    @Autowired
    ThreeDataSourceProperties threeDataSourceProperties;
     ...
     * 另一个数据源 MES
     */
    private DruidDataSource mesDataSource() {
        DruidDataSource dataSource = new DruidDataSource();
        druidProperties.config(dataSource);
        threeDataSourceProperties.config(dataSource);
        return dataSource;
    }
    ...
    public DynamicDataSource mutiDataSource() {
        ...
        DruidDataSource mesDataSource = mesDataSource();
        ...
        hashMap.put(DatasourceEnum.DATA_SOURCE_MES, mesDataSource);
